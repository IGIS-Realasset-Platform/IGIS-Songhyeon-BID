...
export default function Section43_2({ isActive }) {
    ...
    return (
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                {/* 소제목 */}
                <div>
                    <span className="inline-block text-[20px] md:text-[24px] font-bold text-[#1e3a8a] mb-[12px]">{lang === 'kr' ? '[입지적 가치] SBD의 무기 - 서울역 광역교통 결절점과 남산 자연 생태축' : '[Location Value] SBD Weapon: Seoul Station Transit Hub & Namsan Eco Spine'}</span>
                </div>

                {/* 제목 */}
                <h2 className="text-[32px] md:text-[46px] lg:text-[52px] font-extrabold leading-[1.3] text-[#1d1d1f] break-keep mb-4">
                    서울역 광역교통 결절점과 남산 자연 생태축의 시너지
                </h2>
