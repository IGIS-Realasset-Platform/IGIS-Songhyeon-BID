                ...
                <div className={`mt-[10px] max-w-[1000px] text-[15px] md:text-[19px] leading-[1.45] font-medium text-gray-700 break-keep text-center transition-all duration-[689ms] ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    <ul className="text-left inline-block space-y-2 mx-auto">
                        <li className="flex items-start">
                            ...
                            <span>
                                타임스스퀘어는 보행광장 조성 및 BID와의 협업 관리 이후 보행자 부상 40% 감소, 범죄 20% 감소, 대기오염 60% 감소를 달성하여 도심의 안전성과 쾌적성을 획기적으로 개선했습니다.
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="mr-3 text-[#1e3a8a]">▪</span>
                            <span>
                                타임스스퀘어는 뉴욕 전체 면적의 0.1%에 불과하나 뉴욕 경제 산출의 11%를 견인하며, 에어리어 매니지먼트를 통한 자산가치 극대화가 세수를 늘려 시 경제의 핵심 세원이 됨을 증명합니다.
                            </span>
                        </li>
                    </ul>
                </div>
