    ...
    if (match[0].startsWith('@')) {
      nodes.push(
        <span
          ...
          data-feed-mention
          className="font-bold text-[#9ab8b1]"
        >
          {match[0].slice(1)}
        </span>,
      );
